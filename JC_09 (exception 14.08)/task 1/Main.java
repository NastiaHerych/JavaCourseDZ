            ...
            switch (scan.nextInt()) {
                ...
                case 1: {
                    ...
                    if (monthh == true) {
                        ...
                        String wrong = "Wrong month";
                        throw new WrongInputConsoleParametersException(wrong);
                    }
                    break;
                }
                ...
                case 3: {
                    ...
                    if (days == false) {
                        String wrong = "Wrong number of days";
                        throw new WrongInputConsoleParametersException(wrong);
                    }
                    break;
                }
